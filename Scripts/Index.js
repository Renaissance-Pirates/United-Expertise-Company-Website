...
const Toggle_Language = async () =>
{
	...
	Object.keys (International_Text).forEach (ID => document.getElementById (ID) && document.getElementById (ID).placeholder !== undefined ? document.getElementById (ID).placeholder = International_Text [ID] [Language === 'en' ? 'ar' : 'en'] : ((document.getElementById (ID) && document.getElementById (ID).value !== undefined && document.getElementById (ID).value !== 0 && document.getElementById (ID).value !== '') ? document.getElementById (ID).value = International_Text [ID] [Language === 'en' ? 'ar' : 'en'] : document.getElementById (ID) ? document.getElementById (ID).innerHTML = International_Text [ID] [Language === 'en' ? 'ar' : 'en'] : void 0));
	if (Language === 'en')
	{
		...
		document.getElementsByClassName ('Dropdown_Menu_Container') [0].setAttribute ('style', 'padding-right: 2rem;');
